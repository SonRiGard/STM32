...
void Angle_GYRO (I2C_HandleTypeDef *I2Cx, GY80_t *DataStruct){
	...
	char str1[80]={0};	
	sprintf(str1,"Pitch_GYRO : %f\r\n",DataStruct->Pitch_GYRO);
	HAL_UART_Transmit(&huart2,(uint8_t*)str1,strlen(str1),0x1000);
	
	char str2[80]={0};	
	sprintf(str2,"Roll_GYRO : %f\r\n",DataStruct->Roll_GYRO);
	HAL_UART_Transmit(&huart2,(uint8_t*)str2,strlen(str1),0x1000);
	
	char str3[80]={0};	
	sprintf(str3,"Yaw_GYRO : %f\r\n",DataStruct->Yaw_GYRO);
	HAL_UART_Transmit(&huart2,(uint8_t*)str3,strlen(str1),0x1000);
}
void Angle_ACC (I2C_HandleTypeDef *I2Cx, GY80_t *DataStruct){
	...
	char str1[80]={0};	
	sprintf(str1,"Pitch_ACC : %f\r\n",DataStruct->Az);
	HAL_UART_Transmit(&huart2,(uint8_t*)str1,strlen(str1),0x1000);
	
	char str2[80]={0};	
	sprintf(str2,"Roll_ACC : %f\r\n",DataStruct->Roll_ACC);
	HAL_UART_Transmit(&huart2,(uint8_t*)str2,strlen(str1),0x1000);
}
void Kalman_angle_solve (I2C_HandleTypeDef *I2Cx, GY80_t *DataStruct){
	...
	char str1[80]={0};	
	sprintf(str1,"KalmanAngleX : %f\r\n",DataStruct->KalmanAngleX);
	HAL_UART_Transmit(&huart2,(uint8_t*)str1,strlen(str1),0x1000);
	
	char str2[80]={0};	
	sprintf(str2,"KalmanAngleY : %f\r\n",DataStruct->KalmanAngleY);
	HAL_UART_Transmit(&huart2,(uint8_t*)str2,strlen(str1),0x1000);		
}
